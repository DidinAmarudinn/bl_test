...
class DescriptorItem extends StatefulWidget {
  final BluetoothDescriptor descriptor;

  const DescriptorItem({Key? key, required this.descriptor}) : super(key: key);

  @override
  State<DescriptorItem> createState() => _DescriptorItemState();
}

class _DescriptorItemState extends State<DescriptorItem> {
  List<int> _value = [];
